package com.eny.i18n.vue.plugin.tree
...
data class PropertyReference<T>(
    ...
    val type: com.eny.i18n.vue.plugin.factory.LocalizationType,
...
interface CompositeKeyResolver<T> {
    ...
    fun resolve(compositeKey: List<Literal>, root: Tree<T>?, pluralSeparator: String, type: com.eny.i18n.vue.plugin.factory.LocalizationType): List<PropertyReference<T>> =
        tryToResolvePlural(
            resolveCompositeKey(
                compositeKey,
                root,
     ...
     */
    fun resolveCompositeKey(compositeKey: List<Literal>, root: Tree<T>?, type: com.eny.i18n.vue.plugin.factory.LocalizationType): PropertyReference<T> {
     ...
     */
    fun tryToResolvePlural(propertyReference: PropertyReference<T>, pluralSeparator: String, type: com.eny.i18n.vue.plugin.factory.LocalizationType): List<PropertyReference<T>> {
     ...
     */
    fun resolveCompositeKeyProperty(compositeKey: List<Literal>, root: Tree<T>?, type: com.eny.i18n.vue.plugin.factory.LocalizationType): Tree<T>? =
     ...
     */
    fun listCompositeKeyVariants(fixedKey: List<Literal>, root: Tree<T>?, prefix: String, type: com.eny.i18n.vue.plugin.factory.LocalizationType): List<Tree<T>> =
