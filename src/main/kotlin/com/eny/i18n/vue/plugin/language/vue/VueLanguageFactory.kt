package com.eny.i18n.vue.plugin.language.vue
...
import com.eny.i18n.vue.plugin.utils.toBoolean
 ...
 */
class VueLanguageFactory: com.eny.i18n.vue.plugin.factory.LanguageFactory {
...
internal class VueReferenceAssistant: ReferenceAssistant {
    ...
    override fun extractKey(element: PsiElement): FullKey? {
        ...
        return listOf(LiteralKeyExtractor())
                ...
                ?.let{parser.parse(it.extract(element), true, settings.firstComponentNs)}
    }
}
